...
| <a name="input_log_fetcher_resources_cpu"></a> [log\_fetcher\_resources\_cpu](#input\_log\_fetcher\_resources\_cpu) | The CPU request for the log-fetcher sidecar container. | `string` | `"100m"` | no |
| <a name="input_log_fetcher_resources_memory"></a> [log\_fetcher\_resources\_memory](#input\_log\_fetcher\_resources\_memory) | The memory request for the log-fetcher sidecar container. | `string` | `"128Mi"` | no |
...
| <a name="input_timezone"></a> [timezone](#input\_timezone) | Timezone for the container | `string` | `null` | no |
